...
class Single {
  ...
  Map<String, dynamic> toJson() {
    ...
    map['title'] = _title.toString();
    map['ratings'] = _ratings.toString();
    map['preview_text'] = _previewText.toString();
    map['view'] = _view.toString();
    map['id'] = _id.toString();
    map['version'] = _version.toString();
    map['item_type'] = _itemType.toString();
    map['category'] = _category.toString();
    return map;
  }
