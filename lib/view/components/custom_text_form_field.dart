...
class InputTextFieldWidget extends StatefulWidget {
  ...
  const InputTextFieldWidget({Key? key,this.isPassword=false,this.isAddMargin=true,this.textColor=MyColor.colorWhite, this.hintTextColor=MyColor.bodyTextColor,this.fillColor=MyColor.textFieldColor, required this.controller, required this.hintText, this.keyboardType, this.readOnly = false, this.onChanged}) : super(key: key);
        ...
        TextFormField(
          ...
          decoration: InputDecoration(
            ...
            suffixIcon: widget.isPassword ? Padding(
              ...
              child: IconButton(icon:Icon(_obscureText ? Icons.visibility_off : Icons.visibility,color: MyColor.colorWhite,),
                onPressed: _toggle,
              ),
